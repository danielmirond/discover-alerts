...
One of the most fascinating findings: metformin — the antidiabetic drug with anti-aging properties — significantly increases Akkermansia levels. Several researchers propose that a substantial portion of metformin's metabolic benefits are due to its effect on Akkermansia, not the drug itself.
