...
export function getConfig() {
  return {
    ...
    thresholds: {
      ...
      domainScoreJump: envInt('THRESHOLD_DOMAIN_SCORE_JUMP', 20),
      domainNewMinScore: envInt('THRESHOLD_DOMAIN_NEW_MIN_SCORE', 10),
      domainPublicationsJumpPct: envFloat('THRESHOLD_DOMAIN_PUB_JUMP_PCT', 0.5),
      socialScoreJump: envInt('THRESHOLD_SOCIAL_SCORE_JUMP', 20),
      socialNewMinScore: envInt('THRESHOLD_SOCIAL_NEW_MIN_SCORE', 10),
      socialPublicationsJumpPct: envFloat('THRESHOLD_SOCIAL_PUB_JUMP_PCT', 0.5),
