...
ROWS = [
    ...
    ("1953-07-24", "Di Stéfano ficha", "Alfredo Di Stéfano",
     ...
     "Prensa primaria", "Sí (verificada en ESPN, Futbol Gate, Kodro Magazine)",
     "Acabó fichando por el Madrid. URL: https://espndeportes.espn.com/noticias/nota/_/id/2127933/di-stefano-el-fichaje-que-no-fue"),
    ...
    ("1960-1961", "Era Bernabéu presidente", "Santiago Bernabéu (presidente Madrid)",
     "El colegiado Leafe fue el mejor jugador del Barça.",
     "Futbol Gate (retrospectiva) + libros sobre Bernabéu", "Tras eliminatoria Copa de Europa 1960-61", "—",
     "Prensa retrospectiva + libros", "Sí (verificada — Futbol Gate)",
     "Frase sarcástica tras la eliminatoria europea de la 1960-61. URL: https://www.futbolgate.com/investigaci%C3%B3n/el-mayor-atraco-del-siglo-xx"),
    ("1965-1980s", "Era Bernabéu presidente", "Francisco Gento",
     "Se quería que otro club ganara la Copa de Europa, no siempre el mismo.",
     "Atribución (biografías de Gento)", "—", "—",
     "Atribución", "Parcial — atribución repetida en biografías",
     "Frase atribuida en libros sobre la Copa de Europa de los 60. Fuente primaria de hemeroteca no localizada con esta cita exacta."),
    ...
    ("1983-06-26", "Maradona ovacionado Bernabéu", "Diego Armando Maradona",
     ...
     "Olé (entrevista posterior) + reportajes retrospectivos", "Olé entrevistas + Futbol Retro / FC Barcelona", "—",
     "Prensa primaria + retrospectiva", "Sí (acción verificada — cita exacta de Maradona en entrevistas posteriores)",
     "Final Copa de la Liga ida, Bernabéu 2-2 (26/06/1983). URL: https://futbolretro.es/diego-armando-maradona-salio-ovacionado-del-bernabeu/"),
    ...
    # ============ STOICHKOV ============
    ("2010-11-28", "Stoichkov", "Hristo Stoichkov",
     ...
     "Goal + Telecinco + Milenio + La Tercera", "Tras manita 5-0 Camp Nou 28/11/2010", "—",
     "Prensa primaria contemporánea", "Sí (verificada en múltiples medios el 28/11/2010)",
     "Declaraciones de Stoichkov tras el 5-0 al Madrid. URL: https://www.goal.com/es/news/27/liga-de-espa%C3%B1a/2010/11/28/2235578/barcelona-stoichkov-y-unas-declaraciones-subidas-de-tono"),
    ("2010-11-28", "Stoichkov", "Hristo Stoichkov",
     "El Madrid me da asco, nunca me veréis con una camiseta blanca.",
     "Telecinco / La Tercera", "28/11/2010", "—",
     "Prensa primaria contemporánea", "Sí (verificada)",
     "Misma rueda de prensa post-manita. URL: https://www.telecinco.es/noticias/Stoichkov-Real-Madrid-da-asco_0_1101975169.html"),

    # ============ FIGO 2002 ============
    ("2002-11", "Cochinillo a Figo", "Luis Figo",
     "No me siento ni Judas ni traidor.",
     "Infobae (retrospectiva) + Memorias del Fútbol", "Antes del partido 23/11/2002 Camp Nou", "—",
     "Prensa primaria + retrospectiva", "Sí (verificada)",
     "Lanzamientos: cabeza de cochinillo, botellas whisky, agua, móviles. Pancartas 'Judas'. 110 dB. URL: https://www.infobae.com/america/deportes/2019/12/18/el-ultimo-gran-escandalo-en-el-clasico-espanol-en-el-camp-nou-cuando-los-hinchas-del-barcelona-le-tiraron-a-figo-una-cabeza-de-cerdo/"),
    ...
    ("2020-12-18", "Casillas-Mourinho topo", "Iker Casillas",
     "Asumí que yo era el topo.",
     "Movistar+ documental 'Colgar las alas' cap.5 'Amor y odio'", "Emisión 18/12/2020", "—",
     "Documental original", "Sí (verificada)",
     "URL: https://www.eurosport.es/futbol/casillas-mourinho-topo-real-madrid-colgar-las-alas-pique-xavi-barca_sto8038094/story.shtml"),
    ...
    ("2015-11-21", "Iniesta ovación Bernabéu", "Andrés Iniesta",
     ...
     "Múltiples (Eurosport / Sphera / Goal)", "21/11/2015 Bernabéu post-partido", "Sala mixta",
     "Prensa primaria contemporánea", "Sí (verificada)",
     "Madrid 0-4 Barça. URL: https://www.eurosport.es/futbol/clasico/2014-2015/de-ronaldinho-a-iniesta-un-barcelonista-aplaudido-en-el-bernabeu-diez-anos-despues_sto4998640/story.shtml"),
    ("2015-11-21", "Iniesta ovación Bernabéu", "Luis Enrique (entrenador Barça)",
     ...
     "El Desmarque + Última Hora + Milenio", "RP post-partido 21/11/2015", "Sala de prensa Bernabéu",
     "Prensa primaria contemporánea", "Sí (verificada)",
     "URL: https://www.eldesmarque.com/madrid/real-madrid/noticias/3719-luis-enrique-andres-iniesta-es-patrimonio-de-la-humanidad"),

    # ============ PIQUÉ vs RAMOS 2017 ============
    ("2017-04-23", "Ramos-Piqué", "Sergio Ramos",
     "¡Habla ahora, habla ahora!",
     "El Español + Sportyou + OK Diario", "23/04/2017 Bernabéu post-roja", "Campo y vestuarios",
     "Vídeo + prensa primaria", "Sí (verificada)",
     "Tras roja a Ramos, señalando a la grada hacia Piqué. URL: https://www.elespanol.com/elbernabeu/real-madrid/futbol/20170423/ramos-estalla-pique-expulsion-ahora-hablas/210729359_0.html"),
    ...
    ("1988-07", "Schuster ficha por el Madrid", "Ramón Mendoza (presidente Real Madrid)",
     "Es un fichaje con intriga, que daría un susto pequeño o grande a su gran rival.",
     "La Galerna (retrospectiva)", "Tras fichaje julio 1988", "—",
     "Prensa retrospectiva", "Sí (verificada — La Galerna)",
     "Schuster ficha gratis del Barça por el Madrid en julio 1988. URL: https://www.lagalerna.com/schuster-la-galerna/"),
    ("2014", "Schuster retrospectiva", "Bernd Schuster",
     ...
     "Líbero", "Revista Líbero entrevista", "Sección Fútbol Internacional",
     "Prensa primaria", "Sí (verificada)",
     "URL: https://revistalibero.com/blogs/contenidos/schuster-maradona-tenia-una-sombra-tan-grande-que-nos-apagabamos-todos"),
    ("1988-07", "Schuster ficha por el Madrid", "Bernd Schuster",
     "He recuperado las ganas por el fútbol. Llego motivado y con ganas de hacer las cosas bien para ganar títulos.",
     "La Galerna (retrospectiva)", "Tras presentación julio 1988", "—",
     "Prensa retrospectiva", "Sí (verificada)",
     "Tras su fichaje. URL: https://www.lagalerna.com/schuster-la-galerna/"),

    # ============ ERA HUGO SÁNCHEZ (1985-1992) ============
    ("2024-04-20", "Hugo Sánchez sobre el Clásico", "Hugo Sánchez",
     "No necesitas motivación extra contra Barcelona, el mismo rival te la da.",
     "CNN Español", "CNN Deportes 20/04/2024", "Programa CNN Deportes",
     "Vídeo TV", "Sí (verificada)",
     "URL: https://cnnespanol.cnn.com/video/hugo-sanchez-real-madrid-clasico-de-espana-futbol-cnn-deportes-tv/"),
    ("2024-04", "Hugo Sánchez sobre el Clásico", "Hugo Sánchez",
     "¿Cuántas tiene el Madrid y cuántas el Barcelona? (En referencia a Ligas y Champions)",
     "TUDN", "TUDN abril 2024", "—",
     "Vídeo TV", "Sí (verificada)",
     "Burla sobre los títulos. URL: https://www.tudn.com/futbol/la-liga/real-madrid-hugo-sanchez-calienta-clasico-espanol-se-burla-del-barcelona-por-sus-titulos"),
    ...
    ("1959-03-22", "Helenio Herrera (entrenador Barça)", "Helenio Herrera",
     "Ganar sin bajar del autobús. (Antes de Real Betis-Barça en Sevilla)",
     "Marca + Mundo Deportivo", "Antes y tras 22/03/1959 Betis-Barça", "—",
     "Prensa primaria", "Sí (verificada — Marca lo publicó, MD lo desmintió y luego HH lo admitió)",
     "Herrera primero negó, luego admitió diciendo 'bus'. Barça ganó 2-5. URL: https://palabrasdefutbol.com/2021/05/21/ganar-sin-bajar-autocar-origen/"),
    ("1958-1960", "Helenio Herrera (entrenador Barça)", "Helenio Herrera",
...
FRASES_ICONICAS = [
    ...
    ("1988", "Cruyff", "Johan Cruyff",
     ...
     "Prensa primaria", "Atribución (verificación parcial — no localizada en fuente primaria)",
    ...
    ("Años 90", "Cruyff", "Johan Cruyff",
     ...
     "Prensa retrospectiva", "Atribución (verificación parcial — no localizada en fuente primaria)", ""),
    ...
    ("Años 90-2000", "Maradona", "Diego Maradona",
     ...
     "TV", "Atribución (verificación parcial — no localizada en fuente primaria)", ""),
    ...
    ("Años 80-90", "Mendoza presidente Madrid", "Ramón Mendoza",
     ...
     "Hemeroteca digital ABC", "Atribución (verificación parcial — no localizada en fuente primaria)",
    ...
    ("Años 80-90", "Núñez presidente Barça", "Josep Lluís Núñez",
     ...
     "Prensa primaria", "Atribución (verificación parcial — no localizada en fuente primaria)", "Núñez fue presidente 1978-2000."),
    ...
    ("2024", "Florentino", "Florentino Pérez",
     ...
     "Prensa primaria", "Atribución (verificación parcial — no localizada en fuente primaria)", "Sobre el caso Negreira."),
    ...
    # ============ ERA PEP (extras) ============
    ("2010-11", "Pep Guardiola interno (atribución)", "Pep Guardiola",
     "Si esto es un puto Clásico, vais a tener un puto follón.",
     "Atribución (no localizada en fuente primaria)", "—", "—",
     "Atribuida", "NO — atribución repetida sin fuente verificable",
     "Atribuida al vestuario antes del 5-0 (29/11/2010). 'Pep Confidencial' de Martí Perarnau (Roca, 2014) trata el período Bayern, no Barça. Frase puede ser apócrifa o de un libro distinto no localizado."),

    # ============ ERA CRISTIANO RONALDO ============
    ("2018-07-10", "Cristiano salida Madrid", "Cristiano Ronaldo",
     "Estos años en el Real Madrid, y en esta ciudad de Madrid, han sido posiblemente los más felices de mi vida.",
     "Web oficial Real Madrid + OneFootball + Infobae", "Carta despedida 10/07/2018", "Carta manuscrita publicada",
     "Web oficial + prensa", "Sí (verificada)",
     "Texto real de la carta. URL: https://www.infobae.com/america/deportes/2018/07/10/la-carta-de-despedida-de-cristiano-ronaldo-tras-confirmarse-su-pase-a-juventus-han-sido-los-anos-mas-felices-de-mi-vida/"),
    ...
    ("2024", "Cristiano Piers Morgan extras", "Cristiano Ronaldo",
     ...
     "Vídeo TV", "Atribución (verificación parcial — no localizada en fuente primaria)", ""),
    ...
    ("2009-2010", "Ibrahimović en Barça", "Zlatan Ibrahimović",
     ...
     "Libro", "Atribución (verificación parcial — no localizada en fuente primaria)",
    ...
    # ============ ERA HENRY ============
    ("2018", "Henry en el Barça", "Thierry Henry",
     "Si me dices que amas el fútbol y no amas al Barcelona, tienes un problema.",
     "Documental 'Take the ball, pass the ball' (Goal recoge)", "Documental Camp Nou", "—",
     "Documental + prensa", "Sí (verificada)",
     "Henry fichó por el Barça en 2007. URL: https://www.goal.com/es/noticias/henry-si-me-dices-que-amas-el-futbol-y-no-amas-al-barcelona-tienes-un-problema/h0xqj5kq4wfg17ay5bmnhwv96"),
    ...
    ("2010-2017", "Sergio Ramos al Camp Nou", "Sergio Ramos",
     ...
     "Prensa primaria", "Atribución (verificación parcial — no localizada en fuente primaria)", ""),
    ("2013", "Piqué", "Gerard Piqué",
     "Para mí, ser pitado en el Bernabéu es una sinfonía. Pero no con la Selección.",
     "BeSoccer + Goal", "Entrevista 2013", "—",
     "Prensa primaria", "Sí (verificada)",
     "Frase original verificada (versión exacta). URL: https://es.besoccer.com/noticia/me-encanta-que-me-reciban-con-pitos-en-el-bernabeu-1063443"),
    ...
    ("2018", "Piqué adicional", "Gerard Piqué",
     ...
     "Radio + prensa", "Atribución (verificación parcial — no localizada en fuente primaria)", ""),
    ...
    ("2024-2025", "Bellingham en Madrid", "Jude Bellingham",
     ...
     "Prensa primaria", "Atribución (verificación parcial — no localizada en fuente primaria)", ""),
    ("2023-05-22", "Vinicius racismo", "Vinicius Junior",
     "El racismo en los estadios españoles existía antes de que yo hubiera nacido. ¿Qué ha cambiado hasta hoy?",
     "El Gráfico (recoge tweet de Vinicius)", "Tras incidente Mestalla 21/05/2023", "Twitter Vinicius @vinijr",
     "Tweet original verificado", "Sí (verificada)",
     "URL: https://www.elgrafico.com.ar/articulo/futbol-europeo/97836/vinicius-junior-contra-el-racismo-la-cronologia-de-una-lucha-que-ya-suma-20-episodios"),
    ...
    ("2003", "Maragall alcalde Barcelona", "Pasqual Maragall",
     ...
     "Avui", "Discurso 2003", "—",
     "Prensa primaria", "Sí", ""),
    ("2018-12-17", "Aznar PP madridista", "José María Aznar",
     "Soy del Real Madrid desde los 6 años.",
     "Radio Marca + El Español", "Entrevista 17/12/2018", "Radio + prensa",
     "Prensa primaria", "Sí (verificada)",
    ...
    ("2024-04", "Zapatero PSOE Barça", "José Luis Rodríguez Zapatero (recogido por Laporta y Crónica Global)",
     "Yo le di suerte al Barça (vi las Champions de París 2006 y Roma 2009 siendo Presidente).",
     "Crónica Global + OK Diario", "Entrevista pública 2024 + declaración Laporta", "—",
     "Prensa primaria", "Sí (verificada — el único Presidente español que se ha declarado culé)",
     "Laporta lo confirmó: 'era del Barça, un culé de León'. URL: https://cronicaglobal.elespanol.com/culemania/culemaniacos/20240423/jose-luis-rodriguez-zapatero-xavi-yo-barca/849915028_0.html"),
    ...
    ("2006-2009", "Andrés Montes Maldini", "Andrés Montes",
     "Tiqui-taca. ¡Jugón! La vida puede ser maravillosa.",
     "La Sexta + Canal Plus", "Comentarios La Sexta 2006-2009", "—",
     "TV", "Sí (verificada)",
     "Frases icónicas reales de Montes (1955-2009). 'Tira tira tira' y 'Borbones aguantan en la guerra' son apócrifas (no son sus frases). URL: https://en.wikipedia.org/wiki/Andr%C3%A9s_Montes"),
    ("Años 80-actualidad", "Joaquim Maria Puyal", "Joaquim Maria Puyal",
     ...
     "Radio", "Atribución (verificación parcial — no localizada en fuente primaria)",
    ...
    ("Años 2000-actualidad", "Tomás Roncero AS", "Tomás Roncero",
     ...
     "TV + prensa", "Atribución (verificación parcial — no localizada en fuente primaria)", ""),
    ("Años 2010", "Pedrerol Chiringuito", "Josep Pedrerol",
     ...
     "TV", "Sí", ""),
    ("Años 2000", "Andrés Montes Maldini (atribución)", "Andrés Montes",
     "Tienen palas, palas, palas. Son las palas del Madrid contra las palas del Barça. Esto es Excalibur.",
     "Atribución (no localizada en fuente primaria)", "—", "—",
     "Atribuida", "NO — atribución sin fuente verificable",
     "Frase circulada en redes y atribuida a Maldini, no localizada en archivo Canal Plus."),
    ...
    ("Años 90-2000", "Capello en el Madrid", "Fabio Capello",
     ...
     "Atribución (no localizada)", "—", "—",
     "Atribuida", "NO — atribución repetida sin fuente primaria localizada",
     "Frase repetida en redes y blogs pero no localizada en entrevistas verificables a Capello."),
