...
ROWS = [
    ...
    ("1988-07", "Schuster ficha por el Madrid", "Ramón Mendoza (presidente Real Madrid)",
     ...
     "Schuster ficha gratis del Barça por el Madrid en julio 1988."),
    ("1988-1990", "Schuster ficha por el Madrid", "Bernd Schuster",
     "No me fui al Madrid para joder al Barça ni al Atleti para joder al Madrid. Son cosas que pasan.",
     "Líbero", "Entrevista retrospectiva", "—",
     "Entrevista", "Sí", ""),
    ("1988-1990", "Schuster ficha por el Madrid", "Bernd Schuster",
    ...
    ("1958-1960", "Helenio Herrera (entrenador Barça)", "Helenio Herrera",
     ...
     "Panenka", "Recopilación frases", "—",
     "Cita retrospectiva", "Sí",
     "Pionero del entrenador mediático. Influyó en Mourinho."),
    ("1958-1960", "Helenio Herrera (entrenador Barça)", "Helenio Herrera",
    ...
    ("1958-1960", "Helenio Herrera (entrenador Barça)", "Helenio Herrera",
     ...
     "La Pelota No Dobla", "Recopilación frases", "—",
     "Cita retrospectiva", "Sí", ""),
    ("1958-1960", "Helenio Herrera (entrenador Barça)", "Helenio Herrera",
    ...
    ("2015-07-12", "Casillas se despide del Madrid", "Iker Casillas",
     ...
     "Emol", "Rueda de prensa Bernabéu 12/07/2015", "Sala de prensa",
     "RP en directo", "Sí",
     "Sin homenaje oficial. Casillas solo en sala de prensa tras 25 años."),
    ("2015-07-12", "Casillas se despide del Madrid", "Iker Casillas",
    ...
    ("2015-07-12", "Casillas se despide del Madrid", "Iker Casillas",
     "Se terminó.",
     "El Universal (México)", "12/07/2015", "—",
     "RP en directo", "Sí", "Cierre de la rueda de prensa de despedida."),

    # ============ CASILLAS-XAVI PREMIO PRÍNCIPE ASTURIAS 2012 ============
    ("2012", "Casillas y Xavi Premio Asturias", "Iker Casillas + Xavi Hernández",
     "(Premio Príncipe de Asturias de los Deportes 2012, símbolo de reconciliación tras la guerra Mou-Pep)",
     "Memorias del Fútbol", "—", "—",
     "Hecho institucional", "Sí",
     "Tras los 4 Clásicos en 18 días (2011), Casillas llamó a Xavi y Puyol para frenar el conflicto."),
    ("2011 verano", "Casillas y Xavi Premio Asturias", "Xavi Hernández",
     "Fue por el bien del fútbol español. (Sobre la llamada de Casillas para frenar el conflicto)",
     "El Español", "Entrevista retrospectiva", "—",
     "Entrevista", "Sí",
     "Mou se enfureció con Casillas; le acusaría más tarde de ser 'el topo'."),

    # ============ ERA ZIDANE (ENTRENADOR) ============
    ("2016-04-02", "Zidane primer Clásico como entrenador", "Zinedine Zidane",
     ...
     "La Nación", "Previa Camp Nou 2/04/2016", "—",
     "RP previa", "Sí",
     "Madrid 2-1 Barça. Cortó la racha de 39 partidos invicto del Barça."),
    ("2016-2018", "Zidane filosofía de equipo", "Zinedine Zidane",
...
print(f"  Total: {len(ROWS) + len(DIETAS_ROWS)}")
